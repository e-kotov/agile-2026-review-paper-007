...
scenario_names = ["nofilters", "filters", "transitions"]

print("Sorting CSV files by route_nr started ")
results_folder = os.path.abspath(os.path.join(source, '..', 'results_final','vienna'))
...
for name in scenario_names:
    if name == 'transitions':
        path = os.path.abspath(os.path.join(source, '..', 'results_final', 'vienna', name, 'MultiGraph_walk_bike_PT'))
